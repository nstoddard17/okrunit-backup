-- Fix: auto-add the creator as a member of the default team on signup
-- Also update handle_new_user to add user to their default team
...
BEGIN
  ...
  ELSE
    ...
    -- Create default team and add user as member
...
-- Backfill: add team creators as members where they aren't already
