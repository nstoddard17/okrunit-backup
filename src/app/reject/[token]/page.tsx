...
// single "Confirm Rejection" button with an optional reason input. No login
// required -- the token itself is the authentication.
// ---------------------------------------------------------------------------
...
export default async function RejectPage({ params }: PageProps) {
  ...
  if (tokenRow.action !== "reject") {
    return <TokenErrorPage message="This link is not valid for rejecting." />;
  }
